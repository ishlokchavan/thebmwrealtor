    ...
    <section className="mx-auto max-w-6xl px-4 py-14 sm:py-20">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        {features.map((f) => (
          <div
            key={f.title}
            className="group relative overflow-hidden rounded-2xl border border-slate-200/70 bg-white p-6 shadow-soft transition hover:-translate-y-1 hover:border-emerald-200 hover:shadow-card"
          >
            ...
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-carbon-950 text-emerald-300">
